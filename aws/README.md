...
| <a name="input_freeipa_architecture"></a> [freeipa\_architecture](#input\_freeipa\_architecture) | The Architecture to be used for the FreeIPA instances | `string` | `"ARM64"` | no |
